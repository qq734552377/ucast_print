 ...
 */
JNIEXPORT jobject JNICALL Java_com_ucast_jnidiaoyongdemo_Serial_SerialPort_open
...

{
    ...
    /* Configure device */
    {
        ...
        int err = tcsetattr(fd, TCSANOW, &cfg);
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_com_ucast_jnidiaoyongdemo_Serial_SerialPort_close
