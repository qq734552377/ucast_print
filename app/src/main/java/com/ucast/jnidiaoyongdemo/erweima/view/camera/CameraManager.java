...
package com.ucast.jnidiaoyongdemo.erweima.view.camera;
...
//      FlashlightManager.enableFlashlight();
  ...
  public Rect getFramingRect() {
    ...
    if (framingRect == null) {
      ...
      int minHeight = screenResolution.x > screenResolution.y ? screenResolution.x : screenResolution.y;
      int width = minHeight ;
      int height = minWidth * 9 / 10;
